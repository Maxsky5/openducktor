...
1. Install the core tooling: Bun `1.4.2`, Node.js `22.12` or later, Xcode Command Line Tools, `git`, and at least one supported runtime (`opencode`, `codex`, or `claude`).
...
Electron desktop with CDP for agent control:
