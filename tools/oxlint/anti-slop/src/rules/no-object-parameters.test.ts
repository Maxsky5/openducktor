...
tester.run("anti-slop/no-object-parameters", noObjectParametersRule, {
  valid: [
    ...
    "interface Owner { readonly id: string } function f(value: unknown & Owner) {}",
  ...
  invalid: [
    ...
    { code: "function f(value: object & unknown) {}", errors: [error] },
    { code: "function f(value: object & {}) {}", errors: [error] },
    { code: "function f(value: object & NonNullable<unknown>) {}", errors: [error] },
    { code: "function f(value: object & Readonly<unknown>) {}", errors: [error] },
    { code: "function f(value: object & Partial<unknown>) {}", errors: [error] },
    { code: "function f(value: object & Required<unknown>) {}", errors: [error] },
