...
tester.run("anti-slop/no-unsafe-dictionary-type", noUnsafeDictionaryTypeRule, {
  valid: [
    ...
    "type UnknownValuesRequireNarrowing = Record<string, unknown>;",
    "type UnknownIndexRequiresNarrowing = { readonly [key: string]: unknown };",
    "type UnknownMappedValuesRequireNarrowing = { readonly [K in string]: unknown };",
    "type UnknownUnionRequiresNarrowing = { [index: number]: Command; [key: string]: unknown | Command };",
