...
export const HOST_COMMAND_NAMES = [
  ...
  "azure_area_paths_list",
  "build_blocked",
  "build_completed",
  "build_resumed",
  "build_start",
  "custom_agent_role_create",
  "custom_agent_role_delete",
  "custom_agent_role_list",
  "custom_agent_role_update",
  ...
  "workspace_close",
  "workspace_detect_azure_devops_repository",
