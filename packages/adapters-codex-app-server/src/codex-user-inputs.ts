...
export const toCodexTurnInputList = (
  ...
  if (resolvedQuestionRequestIds === undefined) return inputs;

  const placeholder = encodeCodexAsyncQuestionSkips(resolvedQuestionRequestIds);
