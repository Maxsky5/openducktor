...
export type CreateRuntimeTaskActivityGuardPortInput = {
...
export const createRuntimeTaskActivityGuardPort = ({
  runtimeRegistry,
}: CreateRuntimeTaskActivityGuardPortInput): TaskActivityGuardPort => ({
