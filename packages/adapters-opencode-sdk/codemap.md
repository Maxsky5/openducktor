...
- `src/catalog-and-mcp.ts`, `src/message-execution.ts`, and `src/workflow-tool-selection.ts` convert SDK responses into OpenDucktor catalogs and tool selections.
