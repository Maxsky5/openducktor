...
describe("OpenCode approval classifier", () => {
  test.each([
    ...
    },
    {
      ...
      patterns: [`git log "" --output=log.txt`],
  ...
  test.each([
    ...
    "bash --dump-po-strings -c 'exit 42'",
    "bash --help -c 'exit 42'",
    "bash --version -c 'exit 42'",
    "sh -n script.sh",
    "sh -nv script.sh",
    "zsh -n -c 'exit 42'",
    "zsh -o noexec -c 'exit 42'",
    "zsh -o NO_EXEC -c 'exit 42'",
    "zsh --no-exec -c 'exit 42'",
    "zsh --noexec -c 'exit 42'",
    "zsh --no_exec -c 'exit 42'",
    "zsh +o EXEC -c 'exit 42'",
    "zsh +-exec -c 'exit 42'",
    "zsh --help -c 'exit 42'",
    "zsh --version -c 'exit 42'",
    "git stash list",
    "git clean -n",
    "git clean -dfn",
    "git clean -nd",
