...
- Message handling is decomposed into `message-events.ts` plus `message-events/` helpers so assistant/user updates, part deltas, and completion/queued-state reconciliation stay isolated.
