...
Adapter implementation for OpenCode-backed agent sessions, catalogs, tool authorization, message encoding, and event processing.
...
- `catalog-and-mcp.ts`, `payload-mappers.ts`, `message-normalizers.ts`, and `message-execution.ts` transform SDK payloads into core contract shapes.
