...
## Data & Control Flow
`shell-bootstrap.tsx` owns shell readiness, root resolution, bridge configuration, settings/theme preload, crash shell, router, and app render. `App.tsx` mounts providers and routes, and page components turn query/state slices into concrete feature models and dialogs.
