...
## Data & Control Flow
Task lists and workflow state flow into columns/cards, which surface actions back to page models for approval, reset, collapse, or session-start workflows.
