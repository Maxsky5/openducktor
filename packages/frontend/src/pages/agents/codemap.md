...
## Responsibility
Agent Studio route orchestration: task/session navigation, chat surface composition, runtime selection, right-panel state, session creation, runtime readiness, active-session runtime hydration, and URL synchronization.
