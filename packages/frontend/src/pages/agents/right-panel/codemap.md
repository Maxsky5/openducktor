...
`components/features/agents/agent-studio-right-panel`, `agent-studio-build-tools`, `agent-studio-git-panel`, and host open-in commands. Task-worktree query and Open In sequencing are owned by the build-tools snapshot module.
