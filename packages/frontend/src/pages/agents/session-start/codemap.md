...
## Responsibility
Agent Studio session-start bridge: modal flow, runtime selection, reuse-state handling, fresh-session creation, and the session-specific launch helper used by the shell and Kanban flows.
