...
## Data & Control Flow
`use-kanban-page-models.ts` reads workspace/tasks/settings/session state, resolves per-task actions, and hands callbacks into the board and modal components.
