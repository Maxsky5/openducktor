...
Pure policy and adapter helpers stay here: approval policy, prompt overrides, runtime catalog, runtime readiness publication, runtime attachment retry, and host access wrappers.
