...
describe("agent-orchestrator/support/hydrated-message-merge", () => {
  test("keeps hydrated user reference display parts over same-id plain current text", () => {
    const text = "Now tell me what's in @apps/web/src/contexts/ExpenseContext.tsx please";
