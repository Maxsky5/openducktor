...
const loadHistory = (history: History): AgentChatMessage[] =>
...
describe("agent-orchestrator/support/session-history-chat-messages subagents", () => {
  test("merges history-loaded subagent history parts that share a correlation key", () => {
  ...
  test("preserves unresolved history-loaded subagent history rows when no child session link exists", () => {
  ...
  test("surfaces only the identified history-loaded subagent history part when part and session correlation keys differ", () => {
    const subagent = expectSingleSubagent(
      loadHistory([
        {
          messageId: "m-assistant",
  ...
  test("ignores later unidentified history-loaded subagent history rows when an identified row already exists", () => {
    const subagent = expectSingleSubagent(
      loadHistory([
        {
          messageId: "m-assistant",
  ...
  test("ignores ambiguous same-prompt history-loaded subagent history rows without session ids", () => {
    const subagent = expectSingleSubagent(
      loadHistory([
        {
          messageId: "m-assistant",
