...
`use-workspace-operations.ts`, `use-workspace-selection-operations.ts`, `use-workspace-branch-operations.ts`, `use-workspace-branch-probe.ts`, `use-repo-settings-operations.ts`, `check-diagnostics.ts`, and `workspace-operations-model.ts`.
