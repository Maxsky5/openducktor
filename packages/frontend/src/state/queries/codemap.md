...
## Data & Control Flow
Host reads are normalized here, then consumed by pages/components through `useQuery` or imperative preload paths. Mutations elsewhere invalidate these keys, especially runtime catalog and agent-session runtime lookups.
