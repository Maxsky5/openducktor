    ...
    const cases = [
      {
        ...
        expected: { shouldRefreshTaskData: true, shouldRefreshSessionTodos: false },
      },
      {
        ...
        expected: { shouldRefreshTaskData: false, shouldRefreshSessionTodos: false },
      },
      {
        ...
        status: "completed",
        previousStatus: "pending",
        expected: { shouldRefreshTaskData: false, shouldRefreshSessionTodos: true },
      },
      {
