...
## Flow
The service loads repo config, validates hook trust, resolves the builder worktree, starts/stops/restarts each script, and emits group snapshots as terminal/process state changes.
