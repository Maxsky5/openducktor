...
use crate::app_service::test_support::{
    ...
    wait_for_process_exit, with_locked_opencode_process_registry, write_executable_script,
    write_private_file, FakeTaskStore, GitCall, OpencodeProcessRegistryInstance, TaskStoreState,
