...
## Design
This area splits build lifecycle logic from worktree preparation, runtime setup, and session stop handling so start/stop concerns stay isolated. Runtime setup resolves the active runtime connection/route explicitly and does not fall back to a repo default runtime.
