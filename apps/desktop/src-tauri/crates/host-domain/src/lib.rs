...
mod tests {
    ...
    fn public_api_exports_compile() {
        use super::{
            AgentRuntimeKind, AgentSessionDocument, AgentSessionModelSelection,
            AgentSessionStopRequest, AgentWorkflowState, AgentWorkflows, BeadsCheck,
            BuildSessionBootstrap, CreateTaskInput, DevServerEvent, DevServerGroupState,
            DevServerScriptState, DevServerScriptStatus, DevServerTerminalChunk, DirectoryEntry,
            DirectoryListing, GitBranch, GitCommitAllRequest, GitCommitAllResult, GitConflict,
            ...
            RuntimeCapabilities, RuntimeCheck, RuntimeDefinition, RuntimeDescriptor,
            RuntimeForkTarget, RuntimeHistoryCapabilities, RuntimeHistoryFidelity,
            RuntimeHistoryReplay, RuntimeHydratedEventType, RuntimeInstanceSummary,
            RuntimeOmittedPermissionBehavior, RuntimeOptionalSurfaceCapabilities,
            RuntimePendingInputVisibility, RuntimePromptInputCapabilities,
            RuntimePromptInputPartType, RuntimeProvisioningMode, RuntimeQuestionAnswerMode,
            RuntimeRegistry, RuntimeRole, RuntimeSessionLifecycleCapabilities,
            RuntimeSessionStartMode, RuntimeStartupReadinessConfig,
            RuntimeStructuredInputCapabilities, RuntimeSubagentExecutionMode,
            RuntimeSupportedScope, RuntimeWorkflowCapabilities, SpecDocument, SystemCheck,
            SystemOpenInToolId, SystemOpenInToolInfo, TaskAction, TaskCard, TaskDirectMergeResult,
