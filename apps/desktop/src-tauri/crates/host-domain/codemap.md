...
## Design
This crate stays pure and serde-friendly: enums, value objects, trait ports, and round-trip helpers live here with no filesystem or process side effects. Runtime capability definitions belong in descriptor contracts, while live runtime summaries stay metadata-only and session records avoid storing live route data.
