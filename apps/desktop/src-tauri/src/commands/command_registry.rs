pub(crate) fn register_desktop_commands<R: tauri::Runtime>(
    ...
    builder.invoke_handler(tauri::generate_handler![
        ...
        crate::commands::runtime::codex_app_server_request,
        crate::commands::runtime::codex_app_server_notifications,
        crate::commands::runtime::codex_app_server_requests,
        crate::commands::runtime::codex_app_server_respond,
