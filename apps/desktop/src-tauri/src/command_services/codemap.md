...
## Design
Modules define neutral request structs, validation, authorization-sensitive repo/worktree resolution, service/GitPort invocation, and classified errors. They avoid Tauri `State`, Axum response types, HTTP token handling, and JSON envelopes.
